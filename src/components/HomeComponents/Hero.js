	...
	<div class="container">
		...
		<div class="row mt-5">
			<div class="col-md-3 col-sm-6 mb-3 mb-md-0">
				...
				<h4>Satisfied</h4>
				<p>100% clients that are satisfied</p>
			</div>
			<div class="col-md-3 col-sm-6 mb-3 mb-md-0">
				<div class="mb-3">
					...
					<path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z"></path></svg>
				</div>
				<h4>Experience</h4>
				<p>Years of expertise in teaching</p>
			</div>
			<div class="col-md-3 col-sm-6 mb-3 mb-md-0">
				<div class="mb-3">
			...
			<div class="col-md-3 col-sm-6">
				...
				<h4>Strategy</h4>
				<p>Great efforts to take learning next level!</p>
			</div>
		</div>
	</div>
</section>
