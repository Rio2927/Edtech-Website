	...
	<div class="container">
		...
		<div class="row py-3 align-items-center">
			<div class="col-md-6 mt-md-0 mt-4">
				<div class="mb-5 mb-lg-3"><img class="img-fluid" src="https://freefrontend.dev/assets/rectangle-wide.png"></img></div>
			</div>
		...
		<div class="row mt-2">
			<div class="col-lg-3 col-md-6">
				<div class="mb-3 mb-lg-0"><img alt="" class="img-fluid" src="https://freefrontend.dev/assets/rectangle-wide.png"></img></div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="mb-3 mb-lg-0"><img alt="" class="img-fluid" src="https://freefrontend.dev/assets/rectangle-wide.png"></img></div>
			</div>
