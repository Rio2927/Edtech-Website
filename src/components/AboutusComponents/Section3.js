			...
			<div class="col-md-4 order-2 order-md-1">
				<div class="d-flex mb-4 mt-4 mt-md-0">
					...
					<div class="ms-4">
						...
						<p class="fw-light">Access courses anytime, anywhere. Our platform is designed for busy learners, allowing you to study at your own pace.</p>
					</div>
				</div>
				<div class="d-flex mb-4">
					...
					<div class="ms-4">
						...
						<p class="fw-light">Apply your knowledge with practical projects that simulate real-world challenges, ensuring you gain relevant skills for the job market.</p>
					</div>
				</div>
				<div class="d-flex">
					<div class="text-muted">
					...
					<div class="ms-4">
						<h5 class="fw-bold">Personalized Mentorship</h5>
						<p class="fw-light mb-0">Receive one-on-one guidance from experienced mentors who provide feedback, support, and career advice tailored to your goals.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4 ps-lg-5 order-3 order-md-3">
				<div class="d-flex mb-4 mt-5 mt-md-0">
					...
					<div class="ms-4">
						...
						<p class="fw-light">Join a vibrant community of learners and professionals where you can collaborate, network, and share experiences.</p>
					</div>
				</div>
				<div class="d-flex mb-4">
					<div class="text-muted">
					...
					<div class="ms-4">
						<h5 class="fw-bold">Interactive Learning Experience</h5>
						<p class="fw-light">Engage with interactive content, including quizzes, discussions, and live sessions that enhance your understanding and retention.</p>
					</div>
				</div>
				<div class="d-flex">
					<div class="text-muted">
